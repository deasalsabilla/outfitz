...
<head>
  ...
  <title>Beranda - Outfitz Admin</title>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Outfitz</span>
      </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="kategori.php">
          <i class="bi bi-tags"></i><span>Kategori Produk</span>
        </a>
      </li><!-- End Kategori Produk Nav -->

      <li class="nav-item">
        <a class="nav-link collapsed" href="produk.php">
          <i class="bi bi-shop"></i><span>Produk</span></i>
        </a>
      </li><!-- End Produk Nav -->
            ...
            <div class="col-12">
              <div class="card info-card customers-card shadow-sm w-100">
                <div class="card-body text-center py-4">
                  <h4 class="mb-2">Selamat datang di Website Admin <strong>Outfitz!</strong></h4>
