...
<head>
    ...
    <title>Hubungi Kami - Outfitz</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 mb-2 mb-lg-0">
                            <h2 class="title mb-1">Informasi Kontak</h2><!-- End .title mb-2 -->
                            <p class="mb-3">Terinspirasi oleh gaya, didorong oleh kualitas — Outfitz hadir untuk membantumu tampil percaya diri setiap hari. Hubungi kami untuk pertanyaan seputar produk, ukuran, atau rekomendasi gaya yang sesuai dengan kepribadianmu.</p>
                            <div class="row">
                                <div class="col-sm-7">
                                    <div class="contact-info">
                                        ...
                                        <ul class="contact-list">
                                            <li>
                                                ...
                                                Jalan Melati No. 10, Jakarta Selatan, DKI Jakarta 12110, Indonesia

                                            </li>
                                            <li>
                                                <i class="icon-phone"></i>
                                                <a href="tel:#">0812 2728 6595</a>
                                            </li>
                                            <li>
                                                <i class="icon-envelope"></i>
                                                <a href="mailto:#">Outfitz@gmail.com</a>
                                            </li>
                                        </ul><!-- End .contact-list -->
                                    ...
                                    <div class="contact-info">
                                        ...
                                        <ul class="contact-list">
                                            <li>
                                                ...
                                                <span class="text-dark">Senin - Sabtu</span> <br>09.00 - 17.00 WIB
                                            </li>
                                            <li>
                                                <i class="icon-calendar"></i>
                                                <span class="text-dark">Minggu</span> <br>Tutup
                                            </li>
                                        </ul><!-- End .contact-list -->
                                    </div><!-- End .contact-info -->
                                </div><!-- End .col-sm-5 -->
                        ...
                        <div class="col-lg-6">
                            ...
                            <p class="mb-2">Gunakan formulir di bawah ini untuk menghubungi tim kami seputar produk, ukuran, atau rekomendasi gaya terbaik untukmu.</p>
